  ...
  articles = [
    {
     ...
     {
      'id': 5,
      'name': 'Settore Sroduttivo',
      'url': '../.../../assets/images/settore-produttivo.png',
      'subtitle': 'Mense, industrie alimentari, conserviere, panifici, laboratori artigianali dolciari e gelaterie, macelli, allevamenti e stall',
